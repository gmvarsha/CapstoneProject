...
import { Modal, Button, Table, Container, Row, Col, Card, Alert, Spinner, Accordion } from 'react-bootstrap';
...
const AdminCheckIn = () => {
    ...
    return (
        ...
        <div style={{
            ...
            <h1 className="userQuery-header">Admin Web Check-In</h1>
                            ...
                            <Card.Body>
                                <Accordion activeKey={activeKey} onSelect={(key) => setActiveKey(key)}>
                                    ...
                                    <Accordion.Item eventKey="1">
                                        ...
                                        <Accordion.Body>
                                            <p>This section allows you to view and manage passengers who are yet to check in. You can confirm their check-ins and send them messages as needed to complete their check-in process.</p>
